...
const Card = ({recipe}) => {
  ...
  return (
    ...
    <div className="mt-8">
        ...
        <div className="mt-5">
            <button type="button" className="inline-flex items-center rounded-md border border-transparent bg-gray-800 px-3 py-2 text-sm font-medium leading-4 text-white shadow-sm hover:bg-gray-900">{recipe?.createdat}
            </button>
        </div>
    </div>
    </Link>
